...
namespace PortfolioWebApp.Server.Migrations
{
    ...
    [Migration("20250810182846_FixAllPrimaryKeysAndConstraints")]
    partial class FixAllPrimaryKeysAndConstraints
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PortfolioWebApp.Server.Models.Experience", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PortfolioWebApp.Server.Models.Skill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PortfolioWebApp.Server.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PortfolioWebApp.Server.Models.Experience", b =>
                {
                    b.HasOne("PortfolioWebApp.Server.Models.AboutMe", null)
